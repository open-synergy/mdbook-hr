# Memodifikasi Timesheet Computation
...
1. <a name="l1">Buka</a> data timesheet computation yang akan dimodifikasi.
2. Pilih dan sesuaikan **Computation Item** jika dibutuhkan. Harus diisi.
